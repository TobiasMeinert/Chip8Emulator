...
pub fn decode(opcode: u16) DecodedInstruction {
    switch ((opcode & high_nibble) >> 8) {
        ...
        0x60 => return DecodedInstruction.init(InstType.SetVx2NN, opcode),
        0x70 => return DecodedInstruction.init(InstType.AddNN2Vx, opcode),
        0x80 => switch (opcode & low_nibble) {
            // Logic and arithmetic instructions
            0x0 => return DecodedInstruction.init(InstType.SetVy2Vx, opcode),
            ...
            0x4 => return DecodedInstruction.init(InstType.AddVy2Vx, opcode),
            0x5 => return DecodedInstruction.init(InstType.SubVyFromVx, opcode),
            0x6 => return DecodedInstruction.init(InstType.ShiftRight, opcode),
            0x7 => return DecodedInstruction.init(InstType.SubVxFromVy, opcode),
